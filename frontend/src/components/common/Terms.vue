...
이 약관은 멋쟁이상원처럼 주식회사 ("회사" 또는 "멋쟁이상원처럼")가 제공하는  멋쟁이상원처럼 및 멋쟁이상원처럼 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
<br>
<br>
 <div class="bold">
제 2 조 (정의)
...
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 멋쟁이상원처럼 및 멋쟁이상원처럼 관련 제반 서비스를 의미합니다.
...
- 게시중단요청서비스 : https://www.instagram.com/sangwonisawesome/
<br>
<br>
 <div class="bold">
제 17 조 (권리의 귀속)
